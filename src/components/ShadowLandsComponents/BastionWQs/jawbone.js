...
*/
  ...
  return (
    <div className="jawboneWQGuide">
      <h1>Megabite (Jawbone) Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerJawboneWQ">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span>Furious Flapping</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Use <span>Call Darkness</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Cast <span>Furious Flapping</span> again.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Finish off Jawbone with <span>Furious Flapping</span>.
                    </p>
                  </div>
                </div>
              )}
              ...
              {(curentActiveSlot1[1].id === slot1pet1[1][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span>Black Claw</span> debuff.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      If Jawbone isn't dead yet, bring any lvl 25 pet to finish
                      him off.
                    </p>
                  </div>
                </div>
              ...
              {curentActiveSlot1[1].id === slot1pet1[1][1].id && (
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span>Flock</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 4+</p>
                    <p>
                      From now on just spam <span>Peck</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
          ...
          <h3>TIP: Ikky is a nice alternative.</h3>
        </div>
