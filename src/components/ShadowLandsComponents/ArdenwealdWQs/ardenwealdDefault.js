...
function ArdenwealdDefault() {
  ...
  return (
    <div className="ardenwealdDefault">
      <h1>Ardenweald Pet World Quests Guides</h1>
      <h2>Choose a guide to follow up from the menu on the left!</h2>
      <p>
        Ardenweald, realm of Night Faes and location of four of the Pet Battle
        World Quests that exists in Shadowlands. Most of the fights are somehow
...
export default ArdenwealdDefault;
