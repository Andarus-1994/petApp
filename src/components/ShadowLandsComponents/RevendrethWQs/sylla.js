...
*/
  ...
  useEffect(() => {
    ...
    requiredPetOneSlot2[0].loading,
    requiredPetOneSlot3[0].loading,
    requiredPetOneSlot2[0],
    requiredPetOneSlot3[0],
    requiredPetOneSlot2[0].pets,
    requiredPetOneSlot1[0].pets,
    requiredPetOneSlot1[0].loading,
    ...
    for (var i = 0; i < slot3pet1.length; i++) {
      for (var j = 0; j < slot3pet1[i].length; j++) {
        if (slot3pet1[i][j].owned && checkPetLevel25(slot3pet1[i][j].id)) {
          newArray2[i].id = slot3pet1[i][j].id;
          newArray2[i].loading = false;
          newArray2[i].found = true;
          break;
        }
...
*/
  ...
  return (
    <div className="syllaWQGuide">
      <h1>Sylla Pet Battle Guide</h1>
      <h2>Revendreth (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerSyllaWQ">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 0 && (
            <div className="FightInstructions">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start by using <span>Dodge</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Deep Bite</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Use the <span>Deep Bite</span> until Ash dies.
                    </p>
                  </div>
                </div>
              )}
              {curentActiveSlot1[0].id === slot1pet1[0][1].id && (
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1-2</p>
                    <p>
                      Start by using <span>Dive</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Use <span>Shell Armor</span> defense ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 4+</p>
                    <p>
                      Use <span>Pinch</span> until Ash dies.
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="turn">
                ...
                <p>Turn 12</p>
                <p>
                  Swarm comes in. Cast <span>Savage Talon</span> to get blinded.
                </p>
              </div>
              <div className="turn">
                {" "}
              ...
              <div className="turn">
                ...
                <p>Turn 14</p>
                <p>
                  Cast <span>Call Darkness</span> if isn't dead by now.
                </p>
              </div>
            </div>
          )}
          ...
          <h3>
            TIP: The Count comes from a treasure in Revendreth.
            <span
              className="loc"
              onClick={() => {
                navigator.clipboard.writeText("/way Revendreth 57, 43");
              }}
            >
              Click Here
            </span>{" "}
            to copy the location. (It needs 99 Infused Ruby Currency)
          </h3>
        </div>
