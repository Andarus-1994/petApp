...
*/
  ...
  return (
    <div className="dragonkinSyllaGuide">
      <h1>Sylla Dragonkin Pet Battle Guide</h1>
      <h2>Revendreth (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerDragonkinSylla">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Lift-Off</span> double-turn ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4+</p>
                    <p>
                      Cast <span>Shadowflame</span> spell until your{" "}
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Emerald Bite</span> to finish-off Ash.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6+</p>
                    <p>
                      Fang comes in. Use <span>Emerald Bite</span> until Ash
                      dies.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 9</p>
                    <p>
                      Swarm comes in. Use <span>Proto-Strike</span> double-turn
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 11</p>
                    <p>
                      Cast <span>Emerald Presence</span> buff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 12</p>
                    <p>
                      Use <span>Emerald Bite</span> until your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot1[0].pets.name}
                      </span>{" "}
                  ...
                  {(curentActiveSlot3[0].id === slot3pet1[0][0].id ||
                    ...
                    <div className="turn">
                      ...
                      <p>
                        ...
                        and cast <span>Surge of Power</span> if it's under
                        700hp. If not, just use <span>Bite</span> to finish him
                        off.
                      </p>
                    </div>
                  )}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Lift-Off</span> double-turn ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 16</p>
                        <p>
                          Cast <span>Arcane Slash</span> to finish him off.
                        </p>
                      </div>
                    </div>
                  )}
              ...
              {curentActiveSlot1[1].id === slot1pet1[1][0].id && (
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Moonfire</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3+</p>
                    <p>
                      Cast <span>Arcane Blast</span> until you finish-off Ash.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6</p>
                    <p>
                      Fang comes in. Cast <span>Moonfire</span> weather ability.
                      He probably kills your{" "}
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast
                      <span>Arcane Blast</span> until you kill Fang.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 10</p>
                    <p>
                      Swarm comes in. Cast <span>Arcane Blast</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 11</p>
                    <p>
                      Cast <span>Surge of Power</span> burst spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <p>
                      ...
                      and use
                      <span>claw</span> until you win the fight.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Many Dragonkins will do well on third slot.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>TIP: Many Dragonkins will do well on third slot.</h3>
          )}
      ...
      <CommentSection props={{ location: "shadowlands/Sylla/Dragonkin" }} />
    </div>
  );
}

export default DragonkinSylla;
