...
*/
  ...
  return (
    <div className="humanoidSyllaGuide">
      <h1>Sylla Humanoid Pet Battle Guide</h1>
      <h2>Revendreth (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerHumanoidSylla">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Bubble</span> defense ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Nether Blast</span> spell which should kill
                      Ash.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      Fang comes in. Cast <span>Nether Blast</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 7</p>
                    <p>
                      Cast <span>Nether Blast</span> again.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Use <span>Weakness</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 9</p>
                    <p>
                      Cast <span>Nether Blast</span> once more to finish-off
                      Fang.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 10</p>
                    <p>
                      Swarm comes in. Use <span>Nether Blast</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 11</p>
                    <p>
                      Remove your debuffs and heal yourself with{" "}
                      <span>Consume Magic</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 12</p>
                    <p>
                      Cast <span>Nether Blast</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 14</p>
                    <p>
                      Finish the fight with <span>Nether Blast</span>.
                    </p>
                  </div>
                  <span className="tip">
                    Bring in the third pet if any crit happend.
                  </span>
                </div>
              )}
            </div>
              ...
              {curentActiveSlot1[1].id === slot1pet1[1][0].id && (
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Deflection </span> block ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Sandstorm</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3+</p>
                    <p>
                      From now on use <span>Crush</span> until your{" "}
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use
                      <span> Nether Blast</span> to finish Ash.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Fang comes in. Use <span>Sewage Eruption</span> debuff
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 9</p>
                    <p>
                      Cast <span>Expunge</span> burst ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 10</p>
                    <p>
                      Cast <span>Nether Blast</span>. Both pets should die now,
                      if not continue using <span>Nether Blast</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <p>
                      ...
                      and Swarm fight now. Start with
                      <span> Dodge </span> defense ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 12+</p>
                    <p>
                      Use <span>Pounce</span> until you win the fight.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Many Humanoids will do well on third slot.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
              TIP: If you miss attacks on first pet, just restart the battle.
            </h3>
          )}
        </div>
      </div>
      <CommentSection props={{ location: "shadowlands/Sylla/Humanoid" }} />
    </div>
  );
}

export default HumanoidSylla;
