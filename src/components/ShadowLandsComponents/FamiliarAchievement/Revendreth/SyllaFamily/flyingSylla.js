...
*/
  ...
  return (
    <div className="flyingSyllaGuide">
      <h1>Sylla Flying Pet Battle Guide</h1>
      ...
      <div className="containerFlyingSylla">
        <div className="FightRequirements">
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Dark Talon</span> to finish-off Ash.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 5</p>
                        <p>
                          Fang comes in. Cast <span>Moonfire</span> weather
                          ability.
                        </p>
                      </div>
                      <div className="turn">
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 7</p>
                        <p>
                          Cast <span>Soulrush</span> which should kill Fang.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 8</p>
                        <p>
                          Swarm comes in. Use <span>Dark Talon</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 10+</p>
                        <p>
                          Use <span>Dark Talon</span> until your{" "}
                          <span className="hero">
                            {" "}
                            {requiredPetOneSlot2[0].pets.name}{" "}
                          </span>{" "}
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 13+</p>
                        <p>
                          Bring in your level 25 flying and use any offensive
                          abilities to finish-him off.
                        </p>
                      </div>
                    </div>
                  )}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Shadow Talon</span> to finish-off Ash.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 5</p>
                        <p>
                          Fang comes in. Cast <span>Void Tremors</span> debuff
                          ability.
                        </p>
                      </div>
                      <div className="turn">
                        ...
                        <p>Turn 6+</p>
                        <p>
                          Use <span>Shadow Talon</span> until Fang dies.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 8</p>
                        <p>
                          Swarm comes in. Cast <span>Shadow Talon</span> until
                          your{" "}
                          <span className="hero">
                            {" "}
                            {requiredPetOneSlot2[0].pets.name}{" "}
                      ...
                      <div className="turn">
                        {" "}
                        <p>Turn 10</p>
                        <p>Bring in any level 25 flying to finish him off.</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: Crits might disturb the flow of the fight so I recommand
      ...
      <CommentSection props={{ location: "shadowlands/Sylla/Flying" }} />
    </div>
  );
}

export default FlyingSylla;
