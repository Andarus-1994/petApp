...
*/
	...
	return (
		<div className="flyingSyllaGuide">
            ...
            curentActiveSlot1[0].found && (
              ...
              >
                ...
                your Collection.
							...
							{(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
								...
								<div>
									...
									<div className="turn">
										...
										<p>Turn 10+</p>
										<p>
											Fang comes in. Use <span>Absorb</span> until your{" "}
											<span className="hero"> {requiredPetOneSlot1[0].pets.name} </span>
											dies.
										</p>
									</div>
									<div className="turn">
									...
									<div className="turn">
										...
										<p>Turn 15</p>
										<p>
											Swarm comes in. Use <span> Scratch</span> until your{" "}
											<span className="hero"> {requiredPetOneSlot2[0].pets.name} </span> dies.
										</p>
									</div>
									{(curentActiveSlot3[0].id === slot3pet1[0][0].id || curentActiveSlot3[0].id === null) && (
										<div>
											<div className="turn">
												...
												<p>Turn 16</p>
												<p>
													Bring in <span className="hero"> {requiredPetOneSlot2[0].pets.name} </span> and use{" "}
													<span>Phase Shift</span> dodge ability.
												</p>
											</div>
											<div className="turn">
												{" "}
									...
									{(curentActiveSlot3[0].id === slot3pet1[0][1].id || curentActiveSlot3[0].id === slot3pet1[0][2].id) && (
										<div>
											<div className="turn">
												...
												<p>Turn 16</p>
												<p>
													Bring in <span className="hero"> {requiredPetOneSlot2[0].pets.name} </span> and use <span>Bite</span>{" "}
													ability.
												</p>
											</div>
											<div className="turn">
					...
					{curentActiveStrategy === 0 && (
						<h3>TIP: Crits might disturb the flow of the fight so I recommand restarting the battle.</h3>
					)}
					{curentActiveStrategy === 1 && (
						<h3>TIP: Crits might disturb the flow of the fight so I recommand restarting the battle.</h3>
					)}
			...
			<CommentSection props={{ location: "shadowlands/familiar/" + location }} />
		</div>
	);
}
