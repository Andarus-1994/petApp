...
*/
    ...
    }, [petsChar.pets, slotsChecked, active, curentActiveSlot1[0].loading, curentActiveSlot2[0].loading, requiredPetOneSlot2[0].loading, requiredPetOneSlot1[0], requiredPetOneSlot1[0].loading]);
    ...
    function checkPetLevel25(id) {
        if (petsChar.pets.pets.find((pet) => pet.species.id === id && pet.level === 25)) {
            return true;
        } else return false;
    }
...
*/
    ...
    return (
        <div className="flyingSyllaGuide">
            <h1>Sylla Critters Pet Battle Guide</h1>
            <h2>Revendreth (Shadowlands)</h2>
            <div className="difficulty">
                <div className="greenDifficulty"></div>
                <p>Difficulty level:</p>
            </div>
            <div className="containerFlyingSylla">
            ...
            curentActiveSlot1[0].found && (
              ...
              >
                ...
                your Collection.
                    ...
                    {curentActiveStrategy === 0 && (
                        <ul>
                            {!requiredPetOneSlot1[0].loading && requiredPetOneSlot1[0].pets
                                ? requiredPetOneSlot1[0].pets.id === slot1pet1[0][0].id && <Pet pet={requiredPetOneSlot1[0]} petOwned={slot1pet1[0][0]} />
                                : ""}
                            {!requiredPetOneSlot1[0].loading && requiredPetOneSlot1[0].pets
                                ? requiredPetOneSlot1[0].pets.id === slot1pet1[0][1].id && <Pet pet={requiredPetOneSlot1[0]} petOwned={slot1pet1[0][1]} />
                                : ""}

                            {!requiredPetOneSlot2[0].loading && requiredPetOneSlot2[0].pets
                                ? requiredPetOneSlot2[0].pets.id === slot2pet1[0][0].id && <Pet pet={requiredPetOneSlot2[0]} petOwned={slot2pet1[0][0]} />
                                : ""}

                            {!requiredPetOneSlot3[0].loading && requiredPetOneSlot3[0].pets
                                ? requiredPetOneSlot3[0].pets.id === slot3pet1[0][0].id && <Pet pet={requiredPetOneSlot3[0]} petOwned={slot3pet1[0][0]} />
                                : ""}
                            {!requiredPetOneSlot3[0].loading && requiredPetOneSlot3[0].pets
                                ? requiredPetOneSlot3[0].pets.id === slot3pet1[0][1].id && <Pet pet={requiredPetOneSlot3[0]} petOwned={slot3pet1[0][1]} />
                                : ""}
                            {!requiredPetOneSlot3[0].loading && requiredPetOneSlot3[0].pets
                                ? requiredPetOneSlot3[0].pets.id === slot3pet1[0][2].id && <Pet pet={requiredPetOneSlot3[0]} petOwned={slot3pet1[0][2]} />
                                : ""}
                        </ul>
                    )}
                    ...
                    {curentActiveStrategy === 1 && (
                        <ul>
                            {!requiredPetOneSlot1[1].loading && requiredPetOneSlot1[1].pets
                                ? requiredPetOneSlot1[1].pets.id === slot1pet1[1][0].id && <Pet pet={requiredPetOneSlot1[1]} petOwned={slot1pet1[1][0]} />
                                : ""}
                            {!requiredPetOneSlot2[1].loading && requiredPetOneSlot2[1].pets
                                ? requiredPetOneSlot2[1].pets.id === slot2pet1[1][0].id && <Pet pet={requiredPetOneSlot2[1]} petOwned={slot2pet1[1][0]} />
                                : ""}
                            {!requiredPetOneSlot3[1].loading && requiredPetOneSlot3[1].pets
                                ? requiredPetOneSlot3[1].pets.id === slot3pet1[1][0].id && <Pet pet={requiredPetOneSlot3[1]} petOwned={slot3pet1[1][0]} />
                                : ""}
                        </ul>
                    )}
                    {curentActiveStrategy === 0 && (
                        <div className="FightInstructions">
                            ...
                            {(curentActiveSlot1[0].id === slot1pet1[0][0].id || curentActiveSlot1[0].id === slot1pet1[0][1].id || curentActiveSlot1[0].id === null) && (
                                <div>
                                    <div className="turn">
                                        {" "}
                                        <p>Turn 1</p>
                                        <p>
                                            Start with <span> Shell Shield</span> buff ability.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                        <p>Turn 2</p>
                                        <p>
                                            Use <span>Dive</span> double-turn ability.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                    ...
                                    <div className="turn">
                                        ...
                                        <p>Turn 6</p>
                                        <p>
                                            Use <span>Shell Shield</span> buff ability.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                    ...
                                    <div className="turn">
                                        ...
                                        <p>Turn 8</p>
                                        <p>
                                            Use <span>Dive</span> double-turn ability which should kill Ash (use <span>Absorb</span> if not).
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                        <p>Turn 10+</p>
                                        <p>
                                            Fang comes in. Use <span>Absorb</span> until your <span className="hero"> {requiredPetOneSlot1[0].pets.name} </span>
                                            dies.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        ...
                                        <p>
                                            Bring in
                                            <span className="hero"> {requiredPetOneSlot2[0].pets.name} </span>
                                            and use <span>Void Tremors</span>.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                        <p>Turn 13</p>
                                        <p>
                                            Use <span>Early Advantage</span> spell.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                        <p>Turn 14</p>
                                        <p>
                                            Use <span>Scratch</span> which should kill Fang.
                                        </p>
                                    </div>
                                    <div className="turn">
                                        {" "}
                                        <p>Turn 15</p>
                                        <p>
                                            Swarm comes in. Use <span> Scratch</span> until your <span className="hero"> {requiredPetOneSlot2[0].pets.name} </span> dies.
                                        </p>
                                    </div>
                                    {(curentActiveSlot3[0].id === slot3pet1[0][0].id || curentActiveSlot3[0].id === null) && (
                                        <div>
                                            <div className="turn">
                                                {" "}
                                                <p>Turn 16</p>
                                                <p>
                                                    Bring in <span className="hero"> {requiredPetOneSlot2[0].pets.name} </span> and use <span>Phase Shift</span> dodge ability.
                                                </p>
                                            </div>
                                            <div className="turn">
                                                {" "}
                                                <p>Turn 17+</p>
                                                <p>
                                                    Use <span>Bite</span> until you finish-off the fight.
                                                </p>
                                            </div>
                                        </div>
                                    )}
                                    {(curentActiveSlot3[0].id === slot3pet1[0][1].id || curentActiveSlot3[0].id === slot3pet1[0][2].id) && (
                                        <div>
                                            <div className="turn">
                                                {" "}
                                                <p>Turn 16</p>
                                                <p>
                                                    Bring in <span className="hero"> {requiredPetOneSlot2[0].pets.name} </span> and use <span>Bite</span> ability.
                                                </p>
                                            </div>
                                            <div className="turn">
                                                {" "}
                                                <p>Turn 17</p>
                                                <p>
                                                    Use <span>Burrow</span> which should kill Swarm.
                                                </p>
                                            </div>
                                        </div>
                                    )}
                            ...
                            {curentActiveSlot1[1].id === slot1pet1[1][0].id && (
                                <div>
                                    <div className="turn">
                                        ...
                                        <p>Turn 1</p>
                                        <p>
                                            Start with <span> Evanescence </span> dodge ability.
                                        </p>
                                    </div>
                                </div>
                            )}
                    ...
                    {curentActiveStrategy === 0 && <h3>TIP: Crits might disturb the flow of the fight so I recommand restarting the battle.</h3>}
                    {curentActiveStrategy === 1 && <h3>TIP: Crits might disturb the flow of the fight so I recommand restarting the battle.</h3>}
                </div>
            </div>
            <CommentSection props={{ location: "shadowlands/Sylla/Critters" }} />
        </div>
    );
}

export default CrittersSylla;
