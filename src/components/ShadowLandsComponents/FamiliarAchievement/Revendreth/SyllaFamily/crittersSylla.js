              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Use <span>Dive</span> double-turn ability which should
                      kill Ash (use <span>Absorb</span> if not).
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Phase Shift</span> dodge ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Bite</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
