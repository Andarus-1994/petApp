...
*/
  ...
  return (
    <div className="crittersZollaGuide">
      <h1>Zolla Critters Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerCrittersZolla">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 0 && (
            <ul>
              ...
              <li className="anyPet">
                ...
                <p className="level">Any level 25 Critter</p>
              </li>
            </ul>
          )}
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Headbutt</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Nature's Ward</span> spell buff.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3+</p>
                    <p>
                      Use <span>Stampede</span> . From now on use{" "}
                      <span>Headbutt</span> off-cd, <span>Nature's Ward</span>{" "}
                      when there is 1 turn left of the buff and{" "}
                      <span>Stampede</span> as a filler.
                    </p>
                  </div>
                  ...
                  {(curentActiveSlot2[0].id === slot2pet1[0][0].id ||
                    ...
                    <div className="turn">
                      ...
                      <p>
                        ...
                        happens to die bring in{" "}
                        <span className="hero">
                          {requiredPetOneSlot2[0].pets.name}{" "}
                        </span>{" "}
                        and use <span>Poison Fang</span> followed by{" "}
                        <span>Stampede</span> until fight is over.
                      </p>
                    </div>
                  )}
                  {curentActiveSlot2[0].id === slot2pet1[0][1].id && (
                    <div className="turn">
                      ...
                      <p>
                        ...
                        and use <span>Udder Destruction</span>
                        followed by <span>Stampede</span> until fight is over.
                      </p>
                    </div>
                  )}
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: Most of the times any level 25 critter will fit the third
              slot.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
