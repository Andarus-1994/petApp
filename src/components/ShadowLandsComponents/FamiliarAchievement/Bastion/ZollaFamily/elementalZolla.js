...
*/
  ...
  return (
    <div className="elementalZollaGuide">
      <h1>Zolla Elemental Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerElementalZolla">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 0 && (
            <ul>
              ...
              <li className="anyPet">
                ...
                <p>Any Elemental Pet</p>
                <p>No Stats Required</p>
                <p className="level">Any 25 Level </p>
              </li>
            </ul>
          )}
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Stun Seed</span> dot ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 3</p>
                    <p>
                      Use <span>Lash</span> again. Slasher comes in.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      From now on <span>Lash</span> until Slasher dies.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 10-11</p>
                    <p>
                      Battery comes in. Continue Using <span>Lash</span> until
                      Battery dies.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 12</p>
                    <p>
                      Pounder joins the fight. Use <span>Stun Seed</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 13+</p>
                    <p>
                      Continue using <span>Lash</span> until{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Rock Barrage</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 16+</p>
                    <p>
                      Use <span>Rupture</span> followed by <span>Mudslide</span>
                      .
                    </p>
                  </div>
                </div>
              ...
              {curentActiveSlot1[1].id === slot1pet1[1][0].id && (
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Cast <span> Burn</span> ability. Slasher comes in.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Use <span> Leech Seed</span> again.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 9-10</p>
                    <p>
                      Cast <span> Burn</span> until Slasher dies and Battery
                      comes in.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 11+</p>
                    <p>
                      Cast <span> Burn</span> until Battery dies.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 13</p>
                    <p>
                      Pounder comes in. Use <span>Stun Seed</span> on him.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 15+</p>
                    <p>
                      Use <span>Stone Shot</span> until Pounder dies.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: There is a chance that you will need 3rd pet, but it<br></br>{" "}
              is very unlikely (must be very unfortunate with Lash).{" "}
            </h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>TIP: No chance to fail, but the third pet my give a hit.</h3>
          )}
        </div>
      </div>
      <CommentSection props={{ location: "shadowlands/Zolla/Elemental" }} />
    </div>
  );
}

export default ElementalZolla;
