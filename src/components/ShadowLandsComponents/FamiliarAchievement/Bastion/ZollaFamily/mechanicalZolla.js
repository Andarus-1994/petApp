...
*/
  ...
  return (
    <div className="mechanicalZollaGuide">
      <h1>Zolla Mechanical Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerMechanicalZolla">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Use <span> Flamethrower</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4+</p>
                    <p>
                      Use <span> Flamethrower</span> ability until you finish
                      off Battery.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Slasher comes in. Use <span>Sticky Grenade</span> debuff
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Fel Immolate</span> until you kill Slasher.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 12</p>
                    <p>
                      Pounder comes in. Use <span>Call Lightning</span> weather
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 13</p>
                    <p>
                      Cast <span> Fel Immolate</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 14</p>
                    <p>
                      Use <span>Extra Plating</span> defense ability buff.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 15</p>
                    <p>
                      From now on just cast <span>Fel Immolate</span> until you
                      finish the fight.
                    </p>
                  </div>
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              Tip: Would recommand P/P breed for Sky-Bo, but works even with
              S/S.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
...
export default MechanicalZolla;
