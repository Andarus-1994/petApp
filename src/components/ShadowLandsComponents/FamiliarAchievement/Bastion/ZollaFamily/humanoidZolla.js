...
*/
  ...
  return (
    <div className="humanoidZollaGuide">
      <h1>Zolla Humanoid Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerHumanoidZolla">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Cast <span> Ice Lance</span> again. Slasher comes in.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 5+</p>
                    <p>
                      Cast <span> Ice Lance</span> until Slasher dies.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Battery comes in. Use <span>Ice Lance</span> to finish him
                      off.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 9</p>
                    <p>
                      Pounder joins the fight. Use <span>Call Blizzard</span>{" "}
                      weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 10+</p>
                    <p>
                      Cast <span> Ice Lance</span> until you finish him off.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && <h3>Tip: Very easy fight.</h3>}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Zolla/Humanoid" }} />
    </div>
  );
}

export default HumanoidZolla;
