...
*/
  ...
  return (
    <div className="magicZollaGuide">
      <h1>Zolla Magic Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerMagicZolla">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 0 && (
            <ul>
              ...
              {!requiredPetOneSlot3[0].loading && requiredPetOneSlot3[0].pets
                ...
                : ""}
              {!requiredPetOneSlot3[0].loading && requiredPetOneSlot3[0].pets
                ? requiredPetOneSlot3[0].pets.id === slot3pet1[0][3].id && (
                    <Pet
                      pet={requiredPetOneSlot3[0]}
                      petOwned={slot3pet1[0][3]}
                    />
                  )
                : ""}
            </ul>
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Immolation</span> buff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Cast <span> Flamethrower</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4+</p>
                    <p>
                      Cast <span> Flamethrower</span> ability until{" "}
                      <span className="hero">
                        {requiredPetOneSlot1[0].pets.name}
                      </span>{" "}
                      dies.
                      <span className="important">
                        If the enemy pet gets stunned just continue the normal
                        rotation with Flamethrower and Vulcano off-cd.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Cast <span>Immolate</span> until Slasher dies.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 11</p>
                    <p>
                      Pounder comes in. Keep using <span>Immolate</span> until{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      dies.
                  ...
                  {(curentActiveSlot2[0].id === slot2pet1[0][0].id ||
                    ...
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 13</p>
                        <p>
                          Use <span>Stench</span> debuff ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 14</p>
                        <p>
                          Use <span>Chew</span> again.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 15</p>
                        <p>Just Pass, Pounder should die now.</p>
                      </div>
                    </div>
                  )}
                  {(curentActiveSlot3[0].id === slot3pet1[0][1].id ||
                    curentActiveSlot3[0].id === slot3pet1[0][2].id ||
                    curentActiveSlot3[0].id === slot3pet1[0][3].id) && (
                    <div>
                      <div className="turn">
                        {" "}
                        <p>Turn 12</p>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 13</p>
                        <p>
                          Cast <span>Dreadful Breath</span> and Slasher should
                          be dead by the end of the ability.
                        </p>
                      </div>
                    </div>
                  )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              Tip: If you manage to stun the first pet once, the fight will
              become much easier.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
      ...
      <CommentSection props={{ location: "shadowlands/Zolla/Magic" }} />
    </div>
  );
}

export default MagicZolla;
