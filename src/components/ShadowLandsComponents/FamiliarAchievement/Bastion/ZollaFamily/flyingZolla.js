...
*/
  ...
  return (
    <div className="flyingZollaGuide">
      <h1>Zolla Flying Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerFlyingZolla">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Scorched Earth</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Renew the <span> Scorched Earth</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6</p>
                    <p>
                      Cast <span>Deep Burn</span>. Both pets should die now.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Use <span> Slicing Wind</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 9</p>
                    <p>
                      Cast <span> Lightning Shield</span> .
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 11</p>
                    <p>
                      Use <span> Slicing Wind</span>. Both pets should die now.
                    </p>
                  </div>
                  <div className="turn">
                    <p>Turn 12</p>
                    <p>
                      ...
                      and use <span>Furious Flapping</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 13</p>
                    <p>
                      Cast <span> Call Darkness</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 14</p>
                    <p>
                      Use <span>Furious Flapping</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 16</p>
                    <p>
                      Finish him off with <span>Furious Flapping</span>.
                    </p>
                  </div>
                </div>
              )}
      ...
      <CommentSection props={{ location: "shadowlands/Zolla/Flying" }} />
    </div>
  );
}

export default FlyingZolla;
