...
*/
  ...
  return (
    <div className="aquaticZollaGuide">
      <h1>Zolla Aquatic Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerAquaticZolla">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Ice Tomb</span> debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Use<span> Call Blizzard</span> weather spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Cast <span> Ice Lance</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 4</p>
                    <p>
                      Cast <span> Ice Lance</span> spell. Slasher gets swapped
                      in.
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      Cast <span> Call Blizzard</span> weather spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Crush</span> which kills Slasher.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 10</p>
                        <p>
                          Battery swaps in. Use <span>Crush</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 11</p>
                        <p>
                          Use <span>Body Slam</span> ability to kill Battery.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 12</p>
                        <p>
                          Pounder comes in. Use <span>Geyser</span> debuff
                          ability.
                        </p>
                      </div>
                      <div className="turn">
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Tail Slap</span> which kills Slasher.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 10</p>
                        <p>
                          Battery swaps in. Use <span>Tail Slap</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 11</p>
                        <p>
                          Use <span>Swallow You Whole</span> to finish off
                          Battery.
                        </p>
                      </div>
                      <div className="turn">
                  ...
                  {(curentActiveSlot3[0].id === slot3pet1[0][0].id ||
                    ...
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 16</p>
                        <p>
                          Cast <span>Dive</span>. Pounder should explode himself
                          now and you will dodge it.
                        </p>
                      </div>
                    </div>
                  )}
                  {curentActiveSlot3[0].id === slot3pet1[0][1].id && (
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 17</p>
                        <p>
                          Use <span>Deep Bite</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 18</p>
                        <p>
                          Use <span>Dive</span> ability. He should explode
                          himself now.
                        </p>
                      </div>
                    </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: Dodge abilities help alot in last phase to avoid Explosion's
              damage.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
      ...
      <CommentSection props={{ location: "shadowlands/Zolla/Aquatic" }} />
    </div>
  );
}

export default AquaticZolla;
