...
*/
  ...
  return (
    <div className="crittersTheniaGuide">
      <h1>Thenia Critters Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerCrittersThenia">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1+</p>
                    <p>
                      Cast <span>Ooze Touch</span> untl your
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      comes in. Cast <span>Apocalypse</span> debuff.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <p>
                      ...
                      and cast
                      <span>Absorb</span> until your pet gets swapped out.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      Cast <span>Ooze Touch</span> until you finish-off Sunset
                      Glimmerfly.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Plains Peachick comes in. Use <span>Ooze Touch</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 9</p>
                    <p>
                      Cast <span>Ooze Touch</span> again.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use
                      <span> Absorb</span> to finish Plains Peachick.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 12</p>
                    <p>
                      Golden Grazer comes in. Use <span>Shell Shield</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 13+</p>
                    <p>
                      Cast <span>Absorb</span> until the fight is over.
                    </p>
                  </div>
                </div>
              )}
              ...
              {curentActiveSlot1[1].id === slot1pet1[1][0].id && (
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Use <span>Early Advantage</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Use <span>Scratch</span> to finish off Sunset Glimmerfly.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 5</p>
                    <p>
                      Plains Peachick comes in. Use <span>Scratch</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 15</p>
                    <p>
                      Use <span>Burrow</span> double-turn ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 16</p>
                    <p>
                      Use <span>Scratch</span> ability to finish him off.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 17</p>
                    <p>
                      Golden Grazer comes in. Use <span>Scratch</span> until
                      your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot2[1].pets.name}{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use
                      <span> Void Tremors</span> debuff ability and then{" "}
                      <span>Scratch</span> until
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot1[1].pets.name}{" "}
                      </span>{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 21+</p>
                    <p>
                      Use <span>Stampede</span> followed by{" "}
                      <span>Headbutt</span> if necessary to finish the fight.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: The pet with Apocalypse must have the lowest HP out of the 3.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
              TIP: Very hard tactic for critters! You might need multiple tries
              but you will get it done eventually.
            </h3>
          )}
        </div>
      </div>
      <CommentSection props={{ location: "shadowlands/Thenia/Critters" }} />
    </div>
  );
}

export default CrittersThenia;
