...
*/
  ...
  return (
    <div className="undeadTheniaGuide">
      <h1>Thenia Undead Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerUndeadThenia">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Call Darkness</span> weather ability.
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Use <span>Spectral Strike</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Use <span>Spirit Claws</span> ability. Your pet will get
                      swapped now.
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Cast <span>Spiritfire Bolt</span> until you finish-off
                      Sunset Glimmerfly.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      Plains Peachick comes in. Cast{" "}
                      <span>Spiritfire Bolt</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 7</p>
                    <p>
                      Cast <span>Spiritfire Bolt</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Finish Plains Peachick with <span>Soulrush</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 9</p>
                    <p>
                      Golden Grazer comes in. Cast <span>Spiritfire Bolt</span>{" "}
                      until your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot2[0].pets.name}{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 14+</p>
                    <p>
                      <span>Spirit Claws</span> until you win the fight.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: I recommand you getting the pet{" "}
              <a
                href="https://www.wowhead.com/item=122107/fragment-of-anger"
                target="_blank"
              >
                Fragment of Anger
              </a>{" "}
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Undead" }} />
    </div>
  );
}

export default UndeadThenia;
