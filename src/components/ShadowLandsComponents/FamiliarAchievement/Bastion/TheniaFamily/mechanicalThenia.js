...
*/
  ...
  return (
    <div className="mechanicalTheniaGuide">
      <h1>Thenia Mechanical Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerMechanicalThenia">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 0 && (
            <div className="FightInstructions">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Make it Rain</span> debuff ability.
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Use <span>Blingtron Gift Package</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Use <span>Make it Rain</span> debuff ability. Your{" "}
                      <span className="hero">
                        {" "}
              ...
              <div className="turn">
                ...
                <p>Turn 4+</p>
                <p>
                  Use <span>Flamethrower</span> until you finish-off Sunset
                  Glimmerfly.
                </p>
              </div>
              <div className="turn">
                ...
                <p>Turn 7</p>
                <p>
                  Plains Peachick comes in. Use <span>Sticky Grenade</span>.
                </p>
              </div>
              <div className="turn">
                {" "}
                <p>Turn 8</p>
                <p>
                  Use <span>Launch</span> double-turn ability.
                </p>
              </div>
              <div className="turn">
                {" "}
                <p>Turn 10</p>
                <p>
                  Use <span>Flamethrower</span> which should be enough to kill
                  Plains Peachick.
                </p>
              </div>
              <div className="turn">
                ...
                <p>Turn 11</p>
                <p>
                  Golden Grazer comes in. Use <span>Sticky Grenade</span> while
              ...
              <div className="turn">
                ...
                <p>Turn 13+</p>
                <p>
                  Cast <span>Fel Immolate</span> until Golden Grazer dies.
                </p>
              </div>
            </div>
          )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP:{" "}
              <a
                href="https://www.wowhead.com/item=94124/sunreaver-micro-sentry"
                target="_blank"
              >
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Mechanical" }} />
    </div>
  );
}

export default MechanicalThenia;
