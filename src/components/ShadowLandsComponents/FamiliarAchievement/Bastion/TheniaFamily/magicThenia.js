...
*/
  ...
  return (
    <div className="magicTheniaGuide">
      <h1>Thenia Magic Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerMagicThenia">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 0 && (
            <ul>
              ...
              {!requiredPetOneSlot1[0].loading && requiredPetOneSlot1[0].pets
                ...
                : ""}
              {!requiredPetOneSlot1[0].loading && requiredPetOneSlot1[0].pets
                ? requiredPetOneSlot1[0].pets.id === slot1pet1[0][2].id && (
                    <Pet
                      pet={requiredPetOneSlot1[0]}
                      petOwned={slot1pet1[0][2]}
                    />
                  )
                : ""}
          ...
          {curentActiveStrategy === 0 && (
            <div className="FightInstructions">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                curentActiveSlot1[0].id === slot1pet1[0][2].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Arcane Storm</span> weather ability.
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Arcane Blast</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Cast <span>Surge of Power</span> which should kill Sunset
                      Glimmerfly.
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5+</p>
                    <p>
                      Cast <span>Arcane Blast</span> until your{" "}
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot1[0].pets.name}
                      </span>{" "}
                  ...
                  {(curentActiveSlot2[0].id === slot2pet1[0][0].id ||
                    ...
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 8</p>
                        <p>
                          Cast <span>Arcane Dash</span> which should kill Plains
                          Peachick, if not just cast one more{" "}
                          <span>Arcane Blast</span>.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 9</p>
                        <p>
                          Golden Grazer comes in. Just cast{" "}
                          <span>Arcane Blast</span> until your{" "}
                          <span className="hero">
                            {" "}
                            {requiredPetOneSlot2[0].pets.name}{" "}
                          </span>{" "}
                  ...
                  {curentActiveSlot2[0].id === slot2pet1[0][1].id && (
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 8+</p>
                        <p>
                          Cast <span>Nether Blast</span> until you finish-off
                          Plains Peachick.
                        </p>
                      </div>
                      <div className="turn">
                        ...
                        <p>Turn 10</p>
                        <p>
                          Golden Grazer comes in. Use <span>Expunge</span>.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 11+</p>
                        <p>
                          Cast <span>Nether Blast</span> until your{" "}
                          <span className="hero">
                            {" "}
                            {requiredPetOneSlot2[0].pets.name}{" "}
                          </span>{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Chaos Beam</span> until you win the fight.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP:{" "}
              <a
                href="https://www.wowhead.com/npc=98237/empowered-manafiend"
                target="_blank"
              >
                Empowered Manafiend
              </a>{" "}
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Magic" }} />
    </div>
  );
}

export default MagicThenia;
