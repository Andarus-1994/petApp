...
*/
  ...
  return (
    <div className="humanoidTheniaGuide">
      <h1>Thenia Humanoid Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerHumanoidThenia">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Gift of Winter's Veil</span> ability.
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Snowball</span> until your{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Cast <span>Nether Blast</span> which should kill Sunset
                      Glimmerfly.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Plains Peachick comes in. Use <span>Sewage Eruption</span>{" "}
                      debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Use <span>Expunge</span> which kills Plains Peachick.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Golden Grazer comes in. Use <span>Nether Blast</span>.
                      Your{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use
                      <span> Gift of Winter's Veil</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast
                      <span>Sandstorm</span> and <span>Crush</span> to finish
                      him off.
                    </p>
                  </div>
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: You can replace Anubisath Idol with another humanoid with the
              HP higher than the other two.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Humanoid" }} />
    </div>
  );
}

export default HumanoidThenia;
