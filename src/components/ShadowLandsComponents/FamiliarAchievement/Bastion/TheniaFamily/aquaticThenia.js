...
*/
  ...
  return (
    <div className="aquaticTheniaGuide">
      <h1>Thenia Aquatic Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerAquaticThenia">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Use <span> Swarm</span> until your{" "}
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      comes in. Cast <span>Ooze Touch</span> to finish-off
                      Sunset Glimmerfly.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Plains Peachick comes in. Use <span>Moonfire</span>{" "}
                      weather ability.
                    </p>
                  </div>
                  <div className="turn">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Use <span>Phase Shift</span> dodge ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8+</p>
                    <p>
                      Cast <span>Ooze Touch</span> until you finish Plains
                      Peachick off.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 10</p>
                    <p>
                      Golden Grazer comes in. Cast <span>Moonfire</span> weather
                      ability. He probably kills your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot2[0].pets.name}{" "}
                      </span>{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 12+</p>
                    <p>
                      Use <span>Tail Slap</span> until the fight is over.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP:{" "}
              <a
                href="https://www.wowhead.com/npc=151632/slimy-hermit-crab"
                target="_blank"
              >
                Slimy Hermit Crab
              </a>{" "}
              here you can find how to get the pet and the other slimy pets.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Aquatic" }} />
    </div>
  );
}

export default AquaticThenia;
