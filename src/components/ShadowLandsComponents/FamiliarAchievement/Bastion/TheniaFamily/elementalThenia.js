...
*/
  ...
  return (
    <div className="elementalTheniaGuide">
      <h1>Thenia Elemental Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerElementalThenia">
        <div className="FightRequirements">
          ...
          {curentActiveStrategy === 1 && (
            <ul>
              ...
              {!requiredPetOneSlot3[1].loading && requiredPetOneSlot3[1].pets
                ...
                : ""}
              {!requiredPetOneSlot3[1].loading && requiredPetOneSlot3[1].pets
                ? requiredPetOneSlot3[1].pets.id === slot3pet1[1][1].id && (
                    <Pet
                      pet={requiredPetOneSlot3[1]}
                      petOwned={slot3pet1[1][1]}
                    />
                  )
                : ""}
              {!requiredPetOneSlot3[1].loading && requiredPetOneSlot3[1].pets
                ? requiredPetOneSlot3[1].pets.id === slot3pet1[1][2].id && (
                    <Pet
                      pet={requiredPetOneSlot3[1]}
                      petOwned={slot3pet1[1][2]}
                    />
                  )
                : ""}
            </ul>
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1+</p>
                    <p>
                      Cast <span>Corrosion</span> ability.
                      <span className="important">
                        Restart the fight if your pet gets asleep.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 2+</p>
                    <p>
                      Cast <span>Ooze Touch</span> until your
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Cast <span>Nightmare</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6</p>
                    <p>
                      Use <span>Lash</span> which should kill Sunset Glimmerfly.
                      <span className="important">
                        Restart the fight if your pet gets asleep.
                      </span>
                    </p>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Plains Peachick comes in. Use <span>Call Darkness</span>{" "}
                      weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8+</p>
                    <p>
                      Use <span>Lash</span> and <span>Nightmare</span> until
                      your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot2[0].pets.name}{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Corrosion</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 11+</p>
                    <p>
                      Cast <span>Ooze Touch</span> until you finish him off.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 13</p>
                    <p>
                      Golden Grazer comes in. Use <span>Creeping Ooze</span>. He
                      should kill your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot1[0].pets.name}{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      comes in. Cast <span>Call Lightning</span> weather
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 15+</p>
                    <p>
                      Use <span>Slicing Wind</span> until you win the fight.
                    </p>
                  </div>
                </div>
              )}
              ...
              {curentActiveSlot1[1].id === slot1pet1[1][0].id && (
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Fist of the Forest </span>burst ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5+</p>
                    <p>
                      Cast <span>Ooze Touch</span> until Sunset Glimmerfly dies.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 7</p>
                    <p>
                      Plains Peachick comes in. Cast <span>Corrosion</span>{" "}
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Cast <span>Ooze Touch</span> until you kill Plains
                      Peachick. If you haven't managed to finish him off, bring
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot1[1].pets.name}{" "}
                      </span>
                      and cast <span>Call Darkness</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 9</p>
                    <p>
                      Golden Grazer comes in. Use{" "}
                      <span>Fist of the Forest</span> burst ability. Your
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot1[1].pets.name}{" "}
                      </span>
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Call Lightning</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 11+</p>
                    <p>
                      Use <span>Slicing Wind</span> until you finish off the
                      fight.
                    </p>
                  </div>
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP:{" "}
              <a href="https://www.wowhead.com/npc=71018/tainted-waveling">
                Tainted Waveling
              </a>{" "}
              here is written how to obtain the pet.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Elemental" }} />
    </div>
  );
}

export default ElementalThenia;
