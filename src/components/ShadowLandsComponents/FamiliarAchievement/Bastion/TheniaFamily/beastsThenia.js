...
*/
  ...
  return (
    <div className="beastsTheniaGuide">
      <h1>Thenia Beasts Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerBeastsThenia">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Slap</span> ability.
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 2</p>
                    <p>
                      Cast <span>Void Cyclone</span> debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3+</p>
                    <p>
                      Use <span>Flank</span> ability until your
                      <span className="hero">
                        {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      comes in. Cast <span>Moonfire</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 7+</p>
                    <p>
                      Use <span>Spirit Claws</span> until Sunset Glimmerfly
                      dies.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8-9</p>
                    <p>
                      Plains Peachick comes in. Use <span>Prowl</span> buff
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 10</p>
                    <p>
                      Cast <span>Moonfire</span> which should one-shot Plains
                      Peachick.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 11+</p>
                    <p>
                      Golden Grazer comes in. Use <span>Spirit Claws</span>{" "}
                      until
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot2[0].pets.name}{" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Poison Fang</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 14</p>
                    <p>
                      Use <span>Puncture Wound</span> to finish off Golden
                      Grazer.
                    </p>
                  </div>
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP:{" "}
              <a
                href="https://www.wowhead.com/item=101771/xu-fu-cub-of-xuen"
                target="_blank"
              >
                Xu-Fu, Cub of Xuen
              </a>{" "}
              is obtained from Celestial Tournament in Pandaria.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Beasts" }} />
    </div>
  );
}

export default BeastsThenia;
