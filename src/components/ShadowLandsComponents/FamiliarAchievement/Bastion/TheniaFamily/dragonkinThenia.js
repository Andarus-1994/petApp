...
*/
  ...
  return (
    <div className="dragonkinTheniaGuide">
      <h1>Thenia Dragonkin Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerDragonkinThenia">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Moonfire</span> weather ability.
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Cast <span>Arcane Explosion</span> until Sunset Glimmerfly
                      is killed.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      Plains Peachick comes in. Use <span>Howl</span> debuff
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Cast <span>Surge of Power</span> which one-shots Plains
                      Peachick.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Golden Grazer comes in and kills{" "}
                      <span className="hero">
                        {" "}
                        {requiredPetOneSlot2[0].pets.name}
                      </span>
                  ...
                  {(curentActiveSlot3[0].id === slot3pet1[0][0].id ||
                    ...
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 10+</p>
                        <p>
                          Cast <span>Zap</span> until you finish the fight.
                        </p>
                      </div>
                    </div>
                  )}
                  {curentActiveSlot3[0].id === slot3pet1[0][1].id && (
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 10+</p>
                        <p>
                          Cast <span>Frost Breath</span> until you finish the
                          fight.
                        </p>
                      </div>
                    </div>
      ...
      <CommentSection props={{ location: "shadowlands/Thenia/Dragonkin" }} />
    </div>
  );
}

export default DragonkinThenia;
