...
*/
  ...
  return (
    <div className="magicStratiosGuide">
      <h1>Stratios Magic Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerMagicStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Arcane Blast</span> spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Cast on <span> Arcane Storm</span> weather spell.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Cast <span> Arcane Blast</span> spell again.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 4</p>
                    <p>
                      One more <span>Arcane Blast</span> cast.(1h left if you
                      got critted once).
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Finish Shelby with <span>Surge of Power</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6</p>
                    <p>
                      Tinyhoof comes in and kills your{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 8+</p>
                    <p>
                      Cast <span>Chaos Beam</span> until you kill Tinyhoof.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 10</p>
                    <p>
                      Glitterwing comes in. Use <span>Life Exchange</span>{" "}
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 11+</p>
                    <p>
                      Use <span>Chaos Beam</span> and <span>Eyeblast</span>{" "}
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Most of the times you won't need a third pet.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Magic" }} />
    </div>
  );
}

export default MagicStratios;
