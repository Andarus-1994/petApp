...
*/
  ...
  return (
    <div className="flyingStratiosGuide">
      <h1>Stratios Flying Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerFlyingStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Black Claw</span> debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Peck</span> to finish Shelby off.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 5</p>
                        <p>
                          Tinyhoof comes in. Use <span>Make it Rain</span>{" "}
                          ability.
                        </p>
                      </div>
                      <div className="turn">
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 7</p>
                        <p>
                          Use <span>Make it Rain</span> again to kill Tinyhoof.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 8</p>
                        <p>
                          Glitterwing comes in. Use <span>Egg Barrage</span>{" "}
                          ability.
                        </p>
                      </div>
                      <div className="turn">
                        ...
                        <p>Turn 9</p>
                        <p>
                          Use <span>Make it Rain</span> ability.{" "}
                          <span className="hero">
                            {requiredPetOneSlot2[0].pets.name}
                          </span>{" "}
                          probably dies here.
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Slicing Wind</span> to finish Shelby
                          off.
                        </p>
                      </div>
                      <div className="turn">
                        ...
                        <p>Turn 5</p>
                        <p>
                          Tinyhoof comes in. Use <span>Lightning Shield</span>{" "}
                          buff spell.
                        </p>
                      </div>
                      <div className="turn">
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 7</p>
                        <p>
                          Cast <span>Slicing Wind</span> to kill Tinyhoof.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 8</p>
                        <p>
                          Glitterwing comes in. Use <span>Jolt</span> and{" "}
                          <span>Slicing Wind</span> until{" "}
                          <span className="hero">
                            {requiredPetOneSlot2[0].pets.name}
                          </span>{" "}
                          dies.
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Soulrush</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        ...
                        <p>
                          Cast
                          <span> Moonfire</span> weather ability.
                        </p>
                      </div>
                    </div>
                  )}
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          comes in. Use <span>Void Tremors</span> debuff
                          ability.
                        </p>
                      </div>
                      <div className="turn">
                        ...
                        <p>Turn 11+</p>
                        <p>
                          Use <span>Shadow Talon</span> until Glitterwing dies.
                        </p>
                      </div>
                    </div>
                  )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Crits and stuns might ruin the strategy.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Flying" }} />
    </div>
  );
}

export default FlyingStratios;
