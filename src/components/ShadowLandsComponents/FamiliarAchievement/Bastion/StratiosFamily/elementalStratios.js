...
*/
  ...
  return (
    <div className="elementalStratiosGuide">
      <h1>Stratios Elemental Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerELementalStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Lash</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 3</p>
                    <p>
                      Use <span>Fist of the Forest</span> which kills Shelby.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 4</p>
                    <p>
                      Tinyhoof comes in. Use <span>Lash</span> until{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Slicing Wind</span> if Tinyhoof is at full
                      hp or <span>Call Lightning</span> if it's damaged and skip
                      to turn 8.
                      <span className="important">
                        If it gets stunned use Slicing Wind or Call Lightning
                        again.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Use <span>Call Lightning</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Use <span>Slicing Wind</span> until your{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      dies.
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Corrosion</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 11+</p>
                    <p>
                      Cast <span>Ooze Touch</span> until Glitterwing dies.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Call Lightning is almost one-shot for the Tinyhoof.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
...
export default ElementalStratios;
