...
*/
  ...
  return (
    <div className="dragonkinStratiosGuide">
      <h1>Stratios Dragonkin Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerDragonkinStratios">
        <div className="FightRequirements">
            ...
            <div className="FightInstructions">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Lift-Off</span> two-turn ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Throw <span>Quills</span> until you kill Shelby.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 5</p>
                    <p>
                      Tinyhoof comes in. Use <span>Quills</span> and{" "}
                      <span className="hero">
              ...
              {curentActiveSlot1[0].id === slot1pet1[0][1].id && (
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Cast <span>Shadowflame</span> spell. Shelby should die
                      now.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 5</p>
                    <p>
                      Tinyhoof comes in. Use <span>Shadowflame</span> and{" "}
                      <span className="hero">
                        {requiredPetOneSlot1[0].pets.name}
                      </span>{" "}
                      dies here.
              ...
              <div className="turn">
                ...
                <p>
                  ...
                  and use <span>Arcane Storm</span> weather ability.
                </p>
              </div>
              <div className="turn">
                {" "}
                <p>Turn 7</p>
                <p>
                  Use <span>Call Lightning</span> weather ability which kills
                  Tinyhoof.
                </p>
              </div>
              <div className="turn">
                ...
                <p>Turn 8</p>
                <p>
                  Glitterwing comes in. Use <span>Tail Sweep</span>.
                </p>
              </div>
              <div className="turn">
                {" "}
                <p>Turn 9</p>
                <p>
                  Use <span>Tail Sweep</span> again.{" "}
                  <span className="hero">
                    {requiredPetOneSlot2[0].pets.name}
                  </span>{" "}
                  dies here.
              ...
              <div className="turn">
                ...
                <p>Turn 11+</p>
                <p>
                  Cast <span>Arcane Blast</span> until you win the fight.
                </p>
              </div>
            </div>
          )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: Stun from Tinyhoof might make the fight more difficult.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Dragonkin" }} />
    </div>
  );
}

export default DragonkinStratios;
