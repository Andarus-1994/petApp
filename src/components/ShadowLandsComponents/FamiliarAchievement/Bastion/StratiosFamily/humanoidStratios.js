...
*/
  ...
  return (
    <div className="humanoidStratiosGuide">
      <h1>Stratios Humanoid Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerHumanoidStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Sandstorm</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 3</p>
                    <p>
                      Use <span>Booby-Trapped Presents</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Ice Lance</span> to finish off Shelby.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 8</p>
                    <p>
                      Tinyhoof comes in. Use <span>Greench's Gift</span> to
                      finish him off.
                      <span className="important">
                        If your pet gets stunned you might need to restart the
                        battle.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 9</p>
                    <p>
                      Glitterwing comes in. Cast <span>Ice Lance</span> until{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      dies.
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Gift of Winter's Veil</span> ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 12+</p>
                        <p>
                          Cast <span>Punish</span> until Glitterwing dies.
                        </p>
                      </div>
                    </div>
                  )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: Any Humanoid with Sandstorm will do well in first slot.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Humanoid" }} />
    </div>
  );
}

export default HumanoidStratios;
