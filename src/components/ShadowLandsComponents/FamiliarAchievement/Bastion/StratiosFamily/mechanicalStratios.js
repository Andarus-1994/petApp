...
*/
  ...
  return (
    <div className="mechanicalStratiosGuide">
      <h1>Stratios Mechanical Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerMechanicalStratios">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Sticky Grenade</span> debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Use <span>Flamethrower</span> until you kill Shelby.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6</p>
                    <p>
                      Tinyhoof comes in. Use <span>Sticky Grenade</span>, your{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Toxic Smoke</span> ability.
                      <span className="important">
                        It is okay if your pet gets stunned.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Use <span>Toxic Smoke</span> again. Tinyhoof should die
                      here.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 9</p>
                    <p>
                      Glitterwing comes in. Use <span>Explode</span>.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    ...
                    <p>
                      ...
                      and cast <span>Arcane Blast</span> until you win the
                      fight.
                    </p>
                  </div>
                </div>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Mechanical" }} />
    </div>
  );
}

export default MechanicalStratios;
