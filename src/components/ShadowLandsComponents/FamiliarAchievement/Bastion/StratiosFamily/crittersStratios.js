...
*/
  ...
  return (
    <div className="crittersStratiosGuide">
      <h1>Stratios Critters Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerCrittersStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Dodge</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 3</p>
                    <p>
                      Use <span> Burrow</span> two-turn ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 6+</p>
                    <p>
                      From now on just <span>Flurry</span> until you kill
                      Shelby.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 8</p>
                    <p>
                      Tinyhoof comes in. Use <span>Burrow</span> two-turn
                      ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Moth Balls</span>.
                      <span className="important">
                        {" "}
                        If Moth Balls didn't slowed Tinyhoof just restart the
                        fight.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 11</p>
                    <p>
                      Use <span>Burrow</span> . Tinyhoof should be dead after
                      the ability ends.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 13</p>
                    <p>
                      Continue using <span>Moth Balls</span> and{" "}
                      <span>Chomp</span> until{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      dies.
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Cute As A Button</span> buff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 15</p>
                    <p>
                      Cast <span>Void Tremors</span> debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 16+</p>
                    <p>
                      Use <span>Scratch</span> until the fight is over.
                    </p>
                  </div>
                </div>
              )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: RNG involved versus second enemy pet.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Critters" }} />
    </div>
  );
}

export default CrittersStratios;
