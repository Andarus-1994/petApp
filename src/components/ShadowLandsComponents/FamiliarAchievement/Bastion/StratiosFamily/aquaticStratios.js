...
*/
  ...
  return (
    <div className="aquaticStratiosGuide">
      <h1>Stratios Aquatic Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerAquaticStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Call Blizzard</span> weather ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Use <span> Ice Tomb</span> debuff ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Cast <span>Ice Lance</span> until Shelby dies.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 5</p>
                    <p>
                      Tinyhoof comes in. Just continue casting{" "}
                      <span>Ice Lance</span>, he will probably kill your{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and use <span>Tail Slap</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 7</p>
                    <p>
                      Cast <span>Call Lightning</span> weather ability.
                      <span className="important">
                        If your pet gets stunned, just restart the battle(25%
                        chance).
                      </span>
                    </p>
                  </div>
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and cast <span>Nether Blast </span> until you finish
                          the fight.
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and cast <span>Dive </span> double-turn ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 12+</p>
                        <p>
                          Now just use <span>Pinch</span> until Glitterwing
                          dies.
                        </p>
                      </div>
                    </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Most of the Slimy Aquatic Pets will do ok for slot 3.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
...
export default AquaticStratios;
