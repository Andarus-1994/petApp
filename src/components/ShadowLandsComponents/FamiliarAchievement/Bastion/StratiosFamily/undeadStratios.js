...
*/
  ...
  return (
    <div className="undeadStratiosGuide">
      <h1>Stratios Undead Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerUndeadStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 4</p>
                    <p>
                      Finish off Shelby with <span>Bone Barrage</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 5</p>
                    <p>
                      Tinyhoof comes in. Swap to{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      and use <span>Siphone Life</span>
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 6+</p>
                    <p>
                      Use <span> Dead Man's Party</span> ability until{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      dies.
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      and cast <span>Call Darkness</span> to finish off
                      Tinyhoof.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 10</p>
                    <p>
                      Glitterwing comes in. Use <span>Lift-Off</span>{" "}
                      double-turn ability.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 12</p>
                    <p>
                      Use <span> Bone Barrage</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                  ...
                  <div className="turn">
                    ...
                    <p>Turn 14</p>
                    <p>
                      Cast <span>Spiritfire Bolt</span> to finish off
                      Glitterwing.
                    </p>
                  </div>
                </div>
          ...
          {curentActiveStrategy === 0 && (
            <h3>TIP: Lift-Off is a very good ability for First Pet.</h3>
          )}
          {curentActiveStrategy === 1 && (
            <h3>
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Undead" }} />
    </div>
  );
}

export default UndeadStratios;
