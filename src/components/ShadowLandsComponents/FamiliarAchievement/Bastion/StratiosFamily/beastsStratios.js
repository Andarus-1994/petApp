...
*/
  ...
  return (
    <div className="beastsStratiosGuide">
      <h1>Stratios Beasts Pet Battle Guide</h1>
      <h2>Bastion (Shadowlands)</h2>
      <div className="difficulty">
        <div className="greenDifficulty"></div>
        <p>Difficulty level:</p>
      </div>
      <div className="containerBeastsStratios">
        <div className="FightRequirements">
              ...
              {(curentActiveSlot1[0].id === slot1pet1[0][0].id ||
                ...
                <div>
                  <div className="turn">
                    ...
                    <p>Turn 1</p>
                    <p>
                      Start with <span> Quills</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 2</p>
                    <p>
                      Use <span> Feathered Frenzy</span> ability.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 3</p>
                    <p>
                      Use <span> Quills</span> ability which kills Shelby.
                    </p>
                  </div>
                  <div className="turn">
                    {" "}
                    <p>Turn 4</p>
                    <p>
                      Tinyhoof comes in. Just cast <span>Quills</span>, he will
                      kill your{" "}
                      <span className="hero">
                  ...
                  <div className="turn">
                    ...
                    <p>
                      ...
                      <span className="important">
                        If your pet gets stunned Cast Poison Fang again.
                      </span>
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 6</p>
                    <p>
                      Cast <span>Puncture Wound</span> which should kill
                      Tinyhoof.
                    </p>
                  </div>
                  <div className="turn">
                    ...
                    <p>Turn 7</p>
                    <p>
                      Glitterwing comes in. Cast <span>Poison Fang</span> until{" "}
                      <span className="hero">
                        {requiredPetOneSlot2[0].pets.name}
                      </span>{" "}
                      dies.
                    ...
                    <div>
                      <div className="turn">
                        ...
                        <p>
                          ...
                          and use <span>Call Darkness</span> weather ability.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 10+</p>
                        <p>
                          Use <span>Onyx Bite</span> until Glitterwing dies.
                        </p>
                      </div>
                    </div>
                  )}
                  {curentActiveSlot3[0].id === slot3pet1[0][1].id && (
                    <div>
                      ...
                      <div className="turn">
                        ...
                        <p>Turn 10</p>
                        <p>
                          Cast <span>Surge of Light</span> spell.
                        </p>
                      </div>
                      <div className="turn">
                        {" "}
                        <p>Turn 11</p>
                        <p>
                          Finish Glitterwing with <span>Twilight Fire</span>.
                        </p>
                      </div>
                    </div>
                  )}
          ...
          {curentActiveStrategy === 0 && (
            <h3>
              TIP: If your pet gets stunned, just re-cast the ability that was
              stunned for.
            </h3>
          )}
          {curentActiveStrategy === 1 && (
      ...
      <CommentSection props={{ location: "shadowlands/Stratios/Beasts" }} />
    </div>
  );
}

export default BeastsStratios;
